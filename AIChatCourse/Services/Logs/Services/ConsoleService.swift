...
enum LogType {
    /// Use 'info' for informitive tasks. These are not considered analytics, issues, or errors.
    case info
    /// Default type for analytics
    case analytic
    /// Issues or errors that should not occur but will not negatively affect user experience
    case warning
