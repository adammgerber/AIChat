...
struct ChatBubbleViewBuilder: View {
    ...
    var body: some View {
        ...
        .padding(.trailing, isCurrentUser ? 0 : 90)
    }
}
        ...
        VStack(spacing: 24) {
            ...
            ChatBubbleViewBuilder(
                message: ChatMessageModel(
                    ...
                    content: AIChatModel(role: .user, content: "This is some longer content that goes on multiple lines tha tgoies another line!"),
                    seenByIds: nil,
                    dateCreated: .now
                )
            )
